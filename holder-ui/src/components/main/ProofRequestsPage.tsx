    ...
    <>
      ...
      {!showProofRequestDetails ? (
        <VStack
          ...
          gap={"1.5rem"}
        >
          <Text fontSize={"clamp(24px,5vw,30px)"}>Proof Requests</Text>

          <ProofRequestsTable
            setProofRequestValues={setProofRequestValues}
            setShowProofRequestDetails={setShowProofRequestDetails}
          />
        </VStack>
      ) : (
        <>
          ...
          >
            ...
            >
              <FaLessThan
                onClick={() => setShowProofRequestDetails(false)}
                cursor={"pointer"}
              ...
              >
                <Image
                  ...
                  height={5}
                />
                <Text>This fund has been verified</Text>
              </HStack>
            </HStack>
            ...
            <VStack
              ...
              justifyContent={"center"}
              alignItems={"start"}
              boxShadow={"0px 4px 4px 0px #1B1B1B1A"}
